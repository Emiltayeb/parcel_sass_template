...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/sass/project-name.scss":[function(require,module,exports) {
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../src/app.js":[function(require,module,exports) {
"use strict";

require("./sass/project-name.scss");
...
function init() {
  ...
  _gsap.default.set(".content p ,.content div ,h1 ,h2 , h3", {
    opacity: 0
  });

  var firstContent = ".content:nth-child(1)";
  var secondContent = ".content:nth-child(2)";
  tl.fromTo("h1", {
    x: -50
  }, {
    x: 0,
  ...
  tl.fromTo("".concat(firstContent, " p"), {
    x: -100
  }, {
    opacity: 1,
    x: 0,
    delay: 1
  }).to("".concat(firstContent, " div"), {
    y: 20,
    opacity: 1
  }, "-=2").fromTo("".concat(secondContent, " p"), {
    x: -100
  }, {
    opacity: 1,
    x: 0
  }).to("".concat(secondContent, " div"), {
    y: 20,
    opacity: 1
  }, "-=2").fromTo("h3", {
    y: 100
    ...
    opacity: 1,
    duration: 2
  }).to("".concat(firstContent, " div  , ").concat(secondContent, " div "), {
    rotate: 5,
    yoyo: true,
    repeat: -1,
    duration: 2
...
init();
},{"./sass/project-name.scss":"../src/sass/project-name.scss","gsap":"../node_modules/gsap/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
